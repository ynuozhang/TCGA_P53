...
save(HiSeq_patients_withTP53mut, file = paste0('./data/',cancer_type,'_HiSeqcounts_w_TP53','.Rdata'))
save(HiSeq_patients_woTP53mut, file = paste0('./data/',cancer_type,'_HiSeqcounts_wo_TP53','.Rdata'))
